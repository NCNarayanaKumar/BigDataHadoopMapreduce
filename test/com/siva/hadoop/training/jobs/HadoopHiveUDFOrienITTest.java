...
public class HadoopHiveUDFOrienITTest {
	...
	public HadoopHiveUDFOrienITTest(String name) {
	...
	public static void main(String[] args) {
		try {
			...
			HadoopHiveUDFOrienITTest test = new HadoopHiveUDFOrienITTest("Hive");
			// Thread.sleep(1000);
			...
			ResultSet res = stmt1.executeQuery("show databases;");

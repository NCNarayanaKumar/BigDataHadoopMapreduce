...
public class ImageToPDF extends Configured implements Tool {
	public static class PDFMapper extends Mapper<Text, ImageToPdfWritable, Text, ImageToPdfWritable> {
		...
		@Override
		public void map(Text key, ImageToPdfWritable value, Context context) throws IOException, InterruptedException {
			try {
	...
	public int run(String[] args) throws Exception {
		...
		job.setOutputValueClass(ImageToPdfWritable.class);
		job.setInputFormatClass(ImageToPdfInputFormat.class);
		job.setOutputFormatClass(ImageToPdfOutputFormat.class);

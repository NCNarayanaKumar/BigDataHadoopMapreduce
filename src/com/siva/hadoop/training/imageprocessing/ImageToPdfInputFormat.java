package com.siva.hadoop.training.imageprocessing;
...
public class ImageToPdfInputFormat extends FileInputFormat<Text, ImageToPdfWritable> {

	@Override
	public RecordReader<Text, ImageToPdfWritable> createRecordReader(InputSplit split, TaskAttemptContext context) throws IOException,
...
class ImageToPdfRecordReader extends RecordReader<Text, ImageToPdfWritable> {
	...
	private ImageToPdfWritable value = null;
	...
	@Override
	public ImageToPdfWritable getCurrentValue() throws IOException, InterruptedException {
	...
	public void readDir(Path file, FileSplit split, Configuration conf) {
		try {
			...
			for (Path path : paths) {
				...
				value = new ImageToPdfWritable(bufferList, name, filedir);
			}
		} catch (Exception e) {

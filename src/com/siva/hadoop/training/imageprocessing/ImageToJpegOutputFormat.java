...
public class ImageToJpegOutputFormat extends FileOutputFormat<Object, ImageToJpegWritable> {
	...
	@Override
	public RecordWriter<Object, ImageToJpegWritable> getRecordWriter(TaskAttemptContext job) throws IOException, InterruptedException {
		this.job = job;
...
class ImageToJpegRecordWriter extends RecordWriter<Object, ImageToJpegWritable> {
	...
	@Override
	public synchronized void write(Object key, ImageToJpegWritable value) throws IOException, InterruptedException {

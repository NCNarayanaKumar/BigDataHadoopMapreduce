...
public class ImageToPdfWritable implements Writable {
	private static final Log log = LogFactory.getLog(ImageToPdfWritable.class);
	public byte[] bytes;
	...
	public ImageToPdfWritable() {

	}

	public ImageToPdfWritable(ArrayList<BufferedImage> buff, ArrayList<String> name, ArrayList<String> dir) {

...
public class ImageToJPEG extends Configured implements Tool {
	public static class ImageMapper extends Mapper<Text, ImageToJpegWritable, Text, ImageToJpegWritable> {
		@Override
		public void map(Text key, ImageToJpegWritable value, Context context) throws IOException, InterruptedException {
	...
	public static class ImageReducer extends Reducer<Text, ImageToJpegWritable, Text, ImageToJpegWritable> {
		...
		@Override
		public void reduce(Text key, Iterable<ImageToJpegWritable> values, Context context) throws IOException, InterruptedException {

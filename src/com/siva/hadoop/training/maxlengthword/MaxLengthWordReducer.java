package com.siva.hadoop.training.maxlengthword;
...
public class MaxLengthWordReducer extends Reducer<Text, LongWritable, Text, NullWritable> {
	...
	protected void reduce(Text key, Iterable<LongWritable> value, Context context) throws java.io.IOException, InterruptedException {

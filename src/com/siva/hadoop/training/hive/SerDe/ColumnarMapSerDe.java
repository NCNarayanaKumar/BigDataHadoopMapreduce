...
public class ColumnarMapSerDe implements SerDe {
	...
	public void initialize(Configuration conf, Properties tableProperties) throws SerDeException {
		final List<TypeInfo> columnTypes = TypeInfoUtils.getTypeInfosFromTypeString(tableProperties.getProperty(LIST_COLUMN_TYPES));
		...
		List<ObjectInspector> columnObjectInspectors = Collections.nCopies(columnNames.size(),
